        ...
        <div class="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div class="flex justify-center lg:justify-end relative">
                <div class="absolute inset-0 flex items-center justify-center -z-10">
                    <div
                        class="bg-blue-100 rounded-full w-[400px] h-[400px] md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px] opacity-70">
                    </div>
                </div>
                {{-- Ilustrasi Dokter --}}
                <img src="assets/img/herosection.png" alt="Dokter Medical Care"
                    class="w-80 md:w-96 lg:w-[450px] relative z-10">
            </div>

        </div>

        <!-- Statistik di bawah Hero -->
        <div class="bg-white rounded-xl shadow-lg p-8 md:p-10 mt-16 max-w-5xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-8 text-center border border-gray-100">
