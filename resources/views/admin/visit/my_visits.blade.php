                            ...
                            <div class="flex-1 space-y-4">
                                ...
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    <div class="flex flex-wrap rounded-md -space-x-px">
                                        ...
                                        <a href="{{ route('admin.visit.my_visits', ['status' => $key, 'search' => $search]) }}" @class([
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Keluhan</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
