...
<head>
    ...
    <style>
        ...
        .clinic-info h2 { font-size: 16pt; margin: 0; font-weight: bold; }
        .clinic-info p { font-size: 10pt; margin: 2px 0; }
    ...
    <table class="header-table">
        <tr>
            ...
            <td class="clinic-info">
                ...
                <p>Jl. Kampus Unesa, Lidah Wetan, Surabaya, 60213</p>
    ...
    <table class="info-header">
        <tr>
            <td style="width: 50%;">
                ...
                <b>Tgl. Lahir:</b> {{ $pasien ? \Carbon\Carbon::parse($pasien->tgl_lahir)->isoFormat('D MMM YYYY') : 'N/A' }}
            </td>
            ...
            <div>
                ...
                <ol class="prescription-list">
                    @foreach($visit->resep as $resep)
                        <li>
                            <span class="drug-name">{{ $resep->obat ? $resep->obat->nama_obat : 'N/A' }} No. {{ $resep->jumlah }}</span><br>
                            <span class="signa">S. {{ $resep->dosis }}</span>
                            @if($resep->catatan)
                                <br><span class="signa" style="font-size: 10pt;">Catatan: {{ $resep->catatan }}</span>
                            @endif
                        </li>
                    @endforeach
                </ol>
    ...
    <div class="screening-section">
        ...
        <table class="info-table">
            <tr>
                ...
                <td>:</td>
                <td>{{ \Carbon\Carbon::parse($visit->screening->tgl_screening)->isoFormat('D MMMM YYYY') }}</td>
            </tr>
            <tr>
                <td>Berat Badan</td>
                <td>:</td>
