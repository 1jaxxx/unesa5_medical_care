                            ...
                            <div>
                                ...
                                <select name="id_obat" id="id_obat" class="form-select mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    ...
                                    @foreach ($obat as $item)
                                        <option value="{{ $item->id_obat }}" {{ old('id_obat') == $item->id_obat ? 'selected' : '' }}>{{ $item->nama_obat }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="id_visit" id="id_visit" class="form-select mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    ...
                                    @foreach ($visits as $visit)
                                        <option value="{{ $visit->id_visit }}" {{ old('id_visit') == $visit->id_visit ? 'selected' : '' }}>{{ $visit->id_visit }} - {{ $visit->pasien->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                                <label for="dosis" class="block font-medium text-sm text-gray-700">Dosis</label>
                                <input type="text" name="dosis" id="dosis" value="{{ old('dosis') }}" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            </div>
                            <div>
                                <label for="jumlah" class="block font-medium text-sm text-gray-700">Jumlah</label>
                                <input type="number" name="jumlah" id="jumlah" value="{{ old('jumlah') }}" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            </div>
                            <div>
                                <label for="tgl_diberikan" class="block font-medium text-sm text-gray-700">Tanggal Diberikan</label>
                                <input type="date" name="tgl_diberikan" id="tgl_diberikan" value="{{ old('tgl_diberikan') }}" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            </div>
                            <div>
                                <label for="catatan" class="block font-medium text-sm text-gray-700">Catatan</label>
                                <textarea name="catatan" id="catatan" rows="3" class="form-textarea mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('catatan') }}</textarea>
                            </div>
                        </div>
