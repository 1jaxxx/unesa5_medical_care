<div class="bg-gray-50 dark:bg-gray-800">
    ...
    <div class="p-6">
        <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-8">
            ...
            <div class="sm:col-span-1">
                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Akun Dibuat</dt>
                <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $pasien->created_at->format('d F Y H:i') }}</dd>
            </div>
            <div class="sm:col-span-1">
                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Akun Diperbarui</dt>
